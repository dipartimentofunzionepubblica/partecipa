...
# Modificata per gestire correttamente l'update delle domande dei questionari e risolvere il bug relativo alla loro errata visualizzazione v. https://github.com/decidim/decidim/issues/13788
          ...
          update_nested_model(form_question, question_attributes, @questionnaire.questions) do |question|
            ...
            form_question.display_conditions.each do |form_display_condition|
              ...
              display_condition_attributes = {
                ...
                decidim_question_id: form_display_condition.decidim_question_id # Linea aggiunta per la risoluzione del bug
              }
