...
#
# Modificata per aumentare le dimensioni del font del help contestuale nel form di registrazione, attraverso modifica della funzione error_and_help_text per inserire la classe css help-text-big
...
module Decidim
  ...
  class FormBuilder < FoundationRailsHelper::FormBuilder
    ...
    def error_and_help_text(attribute, options = {})
      ...
      html += content_tag(:span, options[:help_text_big], class: "help-text-big") if options[:help_text_big]
